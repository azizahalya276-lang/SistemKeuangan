...
public class TabunganForm extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String tujuan = jTextField5.getText().trim();
        String status = jComboBoxStatus.getSelectedItem().toString();

        if (tanggal.isEmpty() || jumlahStr.isEmpty() || tujuan.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Tanggal, jumlah, dan tujuan wajib diisi!");
            return;
        }
        ...
        try {
            ...
            try (Connection conn = KoneksiDB.getConnection()) {
                ...
                if (tabungan == null) {
                    ...
                    // === INSERT TABUNGAN ===
                    String sql2 = "INSERT INTO tabungan (idtransaksi, tujuan) VALUES (?, ?)";
                    PreparedStatement ps2 = conn.prepareStatement(sql2);
                    ps2.setInt(1, idtransaksi);
                    ps2.setString(2, tujuan);
                    ps2.executeUpdate();

                    JOptionPane.showMessageDialog(this, "Tabungan berhasil disimpan!");
                } else {
                    // === UPDATE TRANSAKSI ===
                    ...
                    ps1.setInt(6, tabungan.getIdTabungan());
                    ps1.executeUpdate();

                    // === UPDATE TABUNGAN ===
                    String sql2 = "UPDATE tabungan SET tujuan=? WHERE idtransaksi=?";
                    PreparedStatement ps2 = conn.prepareStatement(sql2);
                    ps2.setString(1, tujuan);
                    ps2.setInt(2, tabungan.getIdTabungan());
                    ps2.executeUpdate();

                    JOptionPane.showMessageDialog(this, "Tabungan berhasil diupdate!");
                }
                dispose();
            }
    ...
    public static void main(String args[]) {
         try {
            ...
            java.util.logging.Logger.getLogger(TabunganForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        java.awt.EventQueue.invokeLater(() -> new TabunganForm().setVisible(true));
    }
